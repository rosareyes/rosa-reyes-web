        ...
        <div>
          ...
          >
            ...
            <path
              ...
              fill=""
              className={
                'fill-green-400  opacity-50 group-hover:fill-[url(#paint0_linear_173_1193)] group-hover:opacity-100 group-hover:transition-all dark:fill-blue-500'
              }
            />
            <path
            ...
            <path
              ...
              className="fill-green-300 group-hover:fill-[#61FF4B] dark:group-hover:fill-blue-200"
            />
            <path
            ...
            <path
              ...
              className="fill-dimWhite group-hover:fill-[#FF4E4E] group-hover:dark:fill-orange-100"
            />
            <path
            ...
            <path
              ...
              className="fill-green-400 group-hover:fill-[#FF4E4E] group-hover:dark:fill-orange-300"
            />
            <path
